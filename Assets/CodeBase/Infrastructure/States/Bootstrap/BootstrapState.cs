...
namespace CodeBase.Infrastructure.States.Bootstrap
{
    public class BootstrapState : IState
    {
        ...
        private void RegisterUtilities()
        {
            ...
            _services.RegisterSingle(new ConnectionsHandler());
        }
        ...
        private void RegisterLobby() =>
            _services.RegisterSingle<ILobby>(new Services.Lobby.Lobby(_networkManager, _services.Single<IUIFactory>(),
